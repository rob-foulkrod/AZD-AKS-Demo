...
resource nodeRecordingRulesRuleGroup 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' = {
  name: 'NodeRecordingRulesRuleGroup-${aksName}'
  location: resourceGroup().location
  properties: {
...
resource kubernetesRecordingRulesRuleGroup 'Microsoft.AlertsManagement/prometheusRuleGroups@2023-03-01' = {
  name: 'KubernetesRecordingRulesRuleGroup-${aksName}'
  location: resourceGroup().location
  properties: {
